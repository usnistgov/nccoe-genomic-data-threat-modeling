(function ($) {
  $(document).ready(function () {
    ...
    var re_nist = new RegExp('^https?:\\/\\/((csrc|nccoe|www|nccoe-mdl-project-fce54a\\.ipages|www\\.nccoe|)*\\.)*(nist\\.gov|doi\\.org)(\\/|$)');
    ...
    $('a.external').leaveNotice({
      siteName: "Genomic Data Threat Modeling for Cybersecurity and Privacy"
    });
  });
})(jQuery);
